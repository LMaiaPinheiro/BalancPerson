const Modal = {
   ...
   const Storage = {
    get(){
        return JSON.parse(localStorage.getItem("balancPerson:transactions")) || []
    },
    set(transactions){
        localStorage.setItem("balancPerson:transactions", JSON.stringify(transactions))
    }
}
    ...
    const DOM = {
        ...
        innerHTMLTrasaction(transaction, index) {
           ...
           const html = `
                ...
                <td>
                <img onclick="Transaction.remove(${index})" src="./assets/minus.svg" alt="Remover lançamento">
                </td>`
